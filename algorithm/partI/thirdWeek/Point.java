...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        if (this.y == that.y) {// horizontal or the same
    ...
    public int compareTo(Point that) {
        ...
        }else{//the y coordinate of the two points are equal
            if (this.x > that.x) {
                return 1;
    ...
    public Comparator<Point> slopeOrder() {
        return new Comparator<Point>() {
            ...
            public int compare(Point p1, Point p2) {               
                double k1 = Point.this.slopeTo(p1);
                double k2 = Point.this.slopeTo(p2);
                if (k1 > k2) {
                    return 1;
                }else if (k1 < k2) {
                    return -1;
